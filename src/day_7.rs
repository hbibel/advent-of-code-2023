...
impl Hand {
    fn from(cards: [char; 5]) -> Hand {
        let hand_type = {
            ...
            if card_to_count.values().any(|count| *count == 5) {
                HandType::FiveOak
            } else if card_to_count.values().any(|count| *count == 4) {
                HandType::FourOak
                ...
                && card_to_count.values().any(|count| *count == 2)
            {
                ...
                HandType::TwoPair
            } else if card_to_count.values().any(|count| *count == 2) {
                HandType::OnePair
            } else {
                HandType::HighCard
            }
...
#[cfg(test)]
mod tests {
    use crate::day_7::total_winnings;
